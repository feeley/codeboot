...
typedargslist: NAME (',' NAME)* ### simplification for now
DISABLE_typedargslist: (
...
varargslist: NAME (',' NAME)* ### simplification for now
DISABLED_varargslist: vfpdef ['=' test ](',' vfpdef ['=' test])* ',' '/' [',' [ (vfpdef ['=' test] (',' vfpdef ['=' test])* [',' [
...
compound_stmt: if_stmt | while_stmt | for_stmt | funcdef ###if_stmt | while_stmt | for_stmt | try_stmt | with_stmt | funcdef | classdef | decorated | async_stmt
